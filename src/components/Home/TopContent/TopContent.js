...
const TopContent = () => {
    ...
    const socialsLogo = [
        { id: 1, logoItem: <FaXTwitter title='Twiter' className='text-gray-500 text-2xl cursor-pointer' />, link: "https://github.com/iXZed026" },
        { id: 2, logoItem: <FaInstagram title='Instagram' className='text-gray-500 text-2xl cursor-pointer' />, link: "https://www.instagram.com/danial_lf83?igsh=MzNlNGNkZWQ4Mg==" },
        { id: 3, logoItem: <FaGithub title='Github' className='text-gray-500 text-2xl cursor-pointer' />, link: "https://github.com/iXZed026" },
        { id: 4, logoItem: <FaTelegram title='Telegram' className='text-gray-500 text-2xl cursor-pointer' />, link: "https://t.me/Dnl_lf" },
    ]

    return (
        <div className="top-content py-12 mb-7">
            <img className='w-16 rounded-full mb-8' src="../../images/me.jpg" alt="image not found!" />
            <h1 id='text-style' className='w-full md:w-[626px] text-3xl sm:text-5xl mb-8 font-bold'>ront-end developer, React specialist, and technology enthusiast</h1>
